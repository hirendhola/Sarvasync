...
export const AccountsIcon: React.FC<IconProps> = ({ className = "", ...props }) => (
  <svg className={`w-5 h-5 ${className}`} viewBox="0 0 24 24" fill="none" {...props}>
    ...
    />
    <path 
      d="M6 21V19C6 18.4696 6.21071 17.9609 6.58579 17.5858C6.96086 17.2107 7.46957 17 8 17H16C16.5304 17 17.0391 17.2107 17.4142 17.5858C17.7893 17.9609 18 18.4696 18 19V21" 
      stroke="currentColor" 
      strokeWidth="1.5" 
      strokeLinecap="round" 
      strokeLinejoin="round"
...
export const BrandIcon: React.FC<IconProps> = ({ className = "", ...props }) => (
  <svg className={`w-8 h-8 ${className}`} viewBox="0 0 32 32" fill="none" {...props}>
    ...
    />
    <path 
      d="M24 16L16 12V20L24 24V16Z" 
      fill="white" 
      opacity="0.5"
    />
    <defs>
      <linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stopColor="oklch(0.5316 0.1409 355.1999)" />
        <stop offset="100%" stopColor="oklch(0.6038 0.2363 344.4657)" />
      </linearGradient>
    </defs>
  </svg>
);
